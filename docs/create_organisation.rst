...
.. figure:: images/search_for_org_link.png
    :width: 100 %
    :align: center
    :alt: The "My Data" page message which includes links to search for, or create, an organisation.
...
.. figure:: images/existing_orgs_list.png
    :width: 100 %
    :align: center
    :alt: A screenshot of how to search existing organisations by name or country.
