...
----------------------------------
While signed in to IATI Account, you can view the reporting organisations that you are associated with on the `'My Data' <https://account.iatistandard.org/en/data/>`_ page. Clicking 'View Organisation' will show full details for your organisation in IATI Account.
