...
To register with IATI, go to the `IATI Account homepage <https://account.iatistandard.org/>`_ and click "Create account":
...
Click "Register" underneath the button to Sign In:

.. figure:: images/sign_in_fields.png
    :width: 50 %
    :align: center
    :alt: Click "Register" on the sign in screen
...
If you want to publish IATI data, follow the guidance on :ref:`how to add yourself to an organisation <create_organisation>`.
