...
* If you need to make changes to your file metadata on the IATI Registry, please do so by Friday 28th November (midnight, UTC). Changes won’t be possible after that until migration is complete on 5th December.

* No action is needed during the week of migration. All existing user accounts, organisations, and dataset information will be automatically migrated to the new service.

* After the migration, you will receive an email with instructions on how to reset your password and log in to IATI Account for the first time.

* Guidance will be available on this IATI Account docs site to guide you through using the new tool.
