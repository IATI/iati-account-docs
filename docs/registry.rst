...
* All existing IATI user accounts, organisations, and data file information from the IATI Registry were automatically migrated to the new service.

* You will need to reset your password before signing in to IATI Account for the first time. 

* You need to sign in successfully to IATI Account once before you can use IATI Publisher or AidStream. After that, you can sign in to these tools using the same email address and password as IATI Account.
